...
searchNavBar.addEventListener("keyup", (e) => {
  ...
  if (e.target.value.length>2){
    ...
    reponse.ingredients.map(element=>element.ingredient.toLowerCase()).includes(input.toLowerCase())
  );
...
searchIngredients.addEventListener("keyup", (e) => {
  const itemGroupIngredients = document.querySelectorAll(".item-group-ingredients-item");
...
searchAppareils.addEventListener("keyup", (e) => {
  const itemGroupAppareils = document.querySelectorAll(".item-group-appareils-item");
  console.log(e.target.value);
...
searchUstensils.addEventListener("keyup", (e) => {
  const itemGroupUstensils = document.querySelectorAll(".item-group-ustensils-item");
  console.log(e.target.value);
